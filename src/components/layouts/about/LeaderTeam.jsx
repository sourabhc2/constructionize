  ...
  constructor(props) {
    ...
    this.state = {
      lead: [
        {
          id: 1,
          srcimg: "/constructionize/assets/img/team/member-1-370x359.jpg",
          name: "Aaron Stanley",
          position: "Project Manager",
        },
        {
          id: 2,
          srcimg: "/constructionize/assets/img/team/member-2-370x359.jpg",
          name: "David Gunsul",
          position: "President",
        },
        {
          id: 3,
          srcimg: "/constructionize/assets/img/team/member-3-370x359.jpg",
