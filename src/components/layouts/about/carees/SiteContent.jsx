            ...
            <div id="site-content" className="site-content clearfix">
                <div id="inner-content" className="inner-content-wrap">
                        ...
                        <div className="owl-carousel owl-theme">
                            <div className="themesflat-gallery style-1 clearfix">
                                <div className="gallery-item">
                                    <div className="inner">
                                        <div className="thumb">
                                            <img src="assets/img/gallery/gallery-1-840x357.jpg" alt="imagealt" />
                    ...
                    <div className="themesflat-headings style-2 clearfix">
                        ...
                        <p className="sub-heading font-size-16 line-height-28 text-666 margin-top-27 letter-spacing-01">Lorem ipsum
                                        ...
                                        <div className="themesflat-content-box clearfix" data-margin="0 22px 0 0px"
                                            ...
                                            <div className="themesflat-list has-icon style-2 icon-left clearfix">
                                                <div className="inner">
                                                    <span className="item">
                                                        ...
                                                        <span className="text">Bonus programme for the shift teams</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="themesflat-spacer clearfix" data-desktop={10} data-mobile={10}
                                            ...
                                            <div className="themesflat-list has-icon style-2 icon-left clearfix">
                                                <div className="inner">
                                                    <span className="item">
                                                        <span className="icon"><i className="fa fa-check" /></span>
                                                        <span className="text">Employer contribution for pension scheme or
                                                            VWL</span>
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="themesflat-list has-icon style-2 icon-left clearfix">
                                                <div className="inner">
                                                    <span className="item">
                                                        <span className="icon"><i className="fa fa-check" /></span>
                                                        <span className="text">Jobticket (discount for public transport) </span>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div className="inner">
                                                    <span className="item">
                                                        ...
                                                        <span className="text">Tech-oriented. You don’t need to be a developer, but
                                                            have to be passionate about tech, web, eCommerce, and all its
                                                            applications.</span>
                                                    </span>
                                                </div>
                                            </div>
                                                ...
                                                <div className="inner">
                                                    <span className="item">
                                                        ...
                                                        <span className="text">Excellent communication and negotiation skills..
                                                            Clear and convincing when you speak, you are also attuned.</span>
                                                    </span>
                                                </div>
                                            </div>
                                            <div className="themesflat-spacer clearfix" data-desktop={10} data-mobile={10}
